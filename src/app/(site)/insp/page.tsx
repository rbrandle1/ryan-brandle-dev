				...
				<div data-section='dark'>
					<section className={cn(styles.section, styles.heroOffset)}>
						<div className={styles.containerGrid}>
							...
							<p className={styles.p}>
								As the web evolves, so do the expectations of users. Our client, a leading e-commerce platform,
								recognized the need to revamp their online presence to better resonate with their target audience. This
								project aimed to redefine their web branding, ensuring a cohesive visual identity across all digital
								touchpoints.
							</p>
							<p className={styles.p}>
							...
							<p className={styles.p}>
								The project's success was evident in the positive feedback from users and stakeholders alike. The
								revamped web branding effectively communicated the client's values, resonating with their target
								audience and ultimately driving business growth.
							</p>
							<Callout
							...
							<p className={styles.p}>
								By embracing a user-centric approach and leveraging cutting-edge technologies, we were able to craft a
								web branding solution that not only met but exceeded the client's expectations. The project's outcome
								serves as a testament to the power of effective branding in driving business success.
							</p>
							<p className={styles.p}>
					...
					<section className={styles.section}>
						<div className={styles.containerGrid}>
							...
							<p className={styles.p}>
								Implementation involved the redesign of the website, social media assets, and marketing materials to
								align with the new brand identity. This ensured a seamless user experience across all platforms,
								reinforcing the brand's message and values.
							</p>
